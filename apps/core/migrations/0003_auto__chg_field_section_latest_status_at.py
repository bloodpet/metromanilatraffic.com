...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_section', 'latest_status_at', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Section.latest_status_at'
        db.alter_column('core_section', 'latest_status_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'core.section': {
            ...
            'latest_status_at': ('django.db.models.fields.DateTimeField', [], {}),
